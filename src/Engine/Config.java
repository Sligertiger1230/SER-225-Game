...
public class Config {
    ...
    // POWER_SAVER does not hog CPU as much, but can potentially stutter/lag on
    // lower end computers if they cannot handle reaching the target FPS
    // MAX_PERFORMANCE will have the game do whatever it takes to reach the target
    // FPS, even if that means hogging the CPU
